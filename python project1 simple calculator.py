...
# Sample Calculator Using Tkinter
...
tk.Button(
    root, text='Clear', padx=20, pady=20, font=('Arial', 16),
    command=clear_entry, bg="#e949a1", fg="#0A0A0A"
).grid(row=row_val, column=col_val, sticky="nsew")
col_val += 1
tk.Button(
    root, text='⌫', padx=20, pady=20, font=('Arial', 16),
    command=backspace, bg="#e949a1", fg="#0f0f0f"
).grid(row=row_val, column=col_val, sticky="nsew")
